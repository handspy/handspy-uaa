package pt.up.hs.uaa.config.timezone;

import pt.up.hs.uaa.UaaApp;
import pt.up.hs.uaa.repository.timezone.DateTimeWrapper;
import pt.up.hs.uaa.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM hs_date_time_wrapper where id=%d", fieldName, id);
    }
