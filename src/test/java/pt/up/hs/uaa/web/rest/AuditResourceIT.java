...
import pt.up.hs.uaa.config.audit.AuditEventConverter;
import pt.up.hs.uaa.domain.PersistentAuditEvent;
import pt.up.hs.uaa.repository.PersistenceAuditEventRepository;
import pt.up.hs.uaa.security.AuthoritiesConstants;

import pt.up.hs.uaa.service.AuditEventService;
