...
import pt.up.hs.uaa.service.dto.PasswordChangeDTO;
import pt.up.hs.uaa.service.dto.UserDTO;
import pt.up.hs.uaa.web.rest.errors.*;
import pt.up.hs.uaa.web.rest.vm.KeyAndPasswordVM;
import pt.up.hs.uaa.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        userService.updateUser(
            userDTO.getFirstName(), userDTO.getLastName(), userDTO.getOrganization(),
            userDTO.getEmail(), userDTO.getCountry(),
            userDTO.getLangKey(), userDTO.getLengthUnit(), userDTO.getTimeUnit(),
            userDTO.getImageUrl()
        );
    }
